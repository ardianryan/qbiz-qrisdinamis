...
export function LoginPage({ error }: LoginPageProps) {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 transition-colors duration-200">
      ...
      {/* LEFT COLUMN / TOP BANNER: BRAND PANEL (Stacked on mobile, side-by-side on desktop) */}
      <div className="w-full md:w-5/12 bg-slate-900 dark:bg-zinc-900 border-b md:border-b-0 md:border-r border-slate-800 dark:border-zinc-800 flex flex-col justify-between p-6 sm:p-10 md:p-12 shrink-0">
        ...
        <div className="my-8 md:my-auto max-w-sm">
      ...
      <div className="w-full md:w-7/12 flex items-center justify-center p-6 sm:p-12 lg:p-20 bg-slate-50 dark:bg-zinc-950">
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl p-8 shadow-sm">
          ...
          {/* Error Message Box */}
          {error && (
            <div className="bg-red-50 dark:bg-red-950/20 text-red-800 dark:text-red-400 border border-red-200 dark:border-red-900/60 rounded-lg p-3.5 flex gap-3 text-xs leading-relaxed mb-5" role="alert">
          ...
          <form action="/login" method="POST" className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="login-email" className="text-xs font-semibold text-slate-600 dark:text-zinc-400">
                Email Address
              </label>
              <input 
                type="email" 
                ...
                className="w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-lg px-3.5 py-2.5 text-sm text-slate-900 dark:text-zinc-50 placeholder-slate-400 focus-visible:ring-1 focus-visible:ring-sky-600 focus-visible:border-sky-600 outline-none transition-all"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                <label htmlFor="login-password" className="text-xs font-semibold text-slate-600 dark:text-zinc-400">
                  Password
                </label>
              ...
              <div className="relative">
                <input 
                  ...
                  required 
                  placeholder="••••••••"
                  className="w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-lg px-3.5 py-2.5 text-sm text-slate-900 dark:text-zinc-50 placeholder-slate-400 focus-visible:ring-1 focus-visible:ring-sky-600 focus-visible:border-sky-600 outline-none transition-all pr-10"
                />
            ...
            <div className="flex items-center gap-2.5 pt-1">
              ...
              />
              <label htmlFor="login-remember" className="text-xs text-slate-500 dark:text-zinc-400 cursor-pointer">
            ...
            <div className="pt-2">
              <button 
                type="submit"
                className="w-full bg-slate-900 hover:bg-slate-800 dark:bg-sky-600 dark:hover:bg-sky-700 text-white font-semibold text-sm py-2.5 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sky-500 flex items-center justify-center gap-2 cursor-pointer shadow-sm"
              >
                Sign In
              </button>
            </div>
          ...
          <div className="text-center pt-4 text-[10px] text-slate-400 dark:text-zinc-550 border-t border-slate-100 dark:border-zinc-800 mt-5">
            Use configured operator credentials to access portal resources.
          </div>
        </div>
      </div>
