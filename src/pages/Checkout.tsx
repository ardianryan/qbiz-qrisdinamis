  ...
  return (
    <html lang="id">
      ...
      <body className="text-slate-800 dark:text-zinc-200 min-h-screen flex items-center justify-center p-0 md:p-6 antialiased">
        ...
        <div className="w-full max-w-[1000px] bg-white dark:bg-zinc-900 checkout-card md:rounded-3xl flex flex-col md:flex-row min-h-screen md:min-h-[600px] transition-all duration-300">
